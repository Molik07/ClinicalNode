...
export default function Team({ teaser = false }: TeamProps) {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden min-h-[120vh] py-28 px-12 border-t-[0.5px] border-[rgba(36,59,36,0.07)] flex flex-col justify-center selection:bg-[#9e6b3a] selection:text-[#faf6ef]"
      style={{
        background: `
